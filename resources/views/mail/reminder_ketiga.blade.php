                        ...
                        <table bgcolor="#FFFFFF" border="0" cellpadding="0" cellspacing="0" class="one-column" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" width="100%">
                            <tbody>
                                <tr>
                                    ...
                                    <h1><span style="color:#000000;"><span style="font-family: verdana, geneva, sans-serif;">Bismillah...</span></span></h1>
                                    ...
                                    <p style="color:#000000; font-size:16px; text-align:left; font-family: Verdana, Geneva, sans-serif; line-height:22px ">Salam Hangat,<br />
                                    Cilsy</p>
                                    </td>
                                </tr>
                            </tbody>
