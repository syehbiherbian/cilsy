...
<body>
    ...
    <div id="sidebar">
        ...
        <ul>
            ...
            <li class="{{ set_active('contributor/dashboard') }}" data-toggle="tooltip" data-placement="right" title="Dashboard">
                    <a href="{{ url('contributor/dashboard') }}">
                    <img src="{{asset('template/kontributor/img/icon/Home.png')}}" alt="" />
                    <span>Dashboard</span>
                </a>
            </li>
            <li class="{{ set_active('contributor/income') }}" data-toggle="tooltip" data-placement="right" title="Kelola Pendapatan">
            ...
            <li class="{{ set_active('contributor/lessons/pending/list') }}"  data-toggle="tooltip" data-placement="right" title="Kelola Tutorial">
            ...
            <li class="{{ set_active('contributor/comments') }}"  data-toggle="tooltip" data-placement="right" title="Kelola Pertanyaan">
            ...
            <li class="{{ set_active('contributor/account/informasi') }}"  data-toggle="tooltip" data-placement="right" title="Kelola Akun Dan Halaman">
