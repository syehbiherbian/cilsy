...
<section class="content">
            ...
            <div class="body">
              ...
              <form action="{{action('VideoController@store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group form-float">
                  <div class="form-line">
                    <select class="form-control show-tick" name="lesson_id">
                      ...
                      <option value="{{$lessons->id}}">{{$lessons->title}}</option>
                      @endforeach
                    </select>
                ...
                <div class="form-group">
                  ...
                  <div class="form-line">
                    <input type="text" name="type" class="form-control" placeholder="video/webm">
                  </div>
                </div>
                <div class="form-group">
  ...
  //         '<a href=javascript:open_popup("assets/filemanager/dialog.php?type=3&popup=1&field_id=fieldID'+j+'") class="btn" type="button">Select</a>'+
  //         '</td>'+
  //         '<td>'+
  //         '<button type="button" name="remove" id="'+j+'" class="btn btn-sm btn-danger btn_remove">'+
  //         '<i class="material-icons">delete</i>'+
