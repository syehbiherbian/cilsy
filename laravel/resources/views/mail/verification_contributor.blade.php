                        ...
                        <td align="center" valign="top">
                            ...
                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="100%" bgcolor="#2BA8E2">
                                <tr>
                                    <td>
                                        <br>
                                        <img src="https://www.cilsy.id/template/web/img/logo-only.png" width="216" height="189" alt="logo cilsy">
                                    </td>
                                </tr>
                                <tr>
                                    <td class="headline">
                                            ...
                                            <table style="margin: 0 auto;" cellpadding="0" cellspacing="0" width="60%">
                                                <tr>
                                                    <td style="color:#ffffff;">
                                                        <br>
                                                        Terima Kasih Sudah Mendaftar Sebagai Contributor di Cilsy Fiolution! Silahkan klik tombol dibawah Untuk Mengaktifkan Akun Anda
                                                        <br>
                                                        <br>
                                                    </td>
                                                </tr>
                                    ...
                                    <td>
                                        <div><!--[if mso]>
                                            <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:50px;v-text-anchor:middle;width:200px;" arcsize="8%" stroke="f" fillcolor="#178f8f">
                                                ...
                                                <center>
                                            <![endif]-->
                                            <a href="{{ url('/contributor/aktivasi/'.$contributor->token ) }}"
                                               style="background-color:#ffffff;border-radius:4px;color:#2BA8E2;display:inline-block;font-family:Helvetica, Arial, sans-serif;font-size:16px;font-weight:bold;line-height:50px;text-align:center;text-decoration:none;width:200px;-webkit-text-size-adjust:none;">Aktivasi Akun</a>
                                            <!--[if mso]>
                                            </center>
                                            </v:roundrect>
                                            <![endif]--></div>
