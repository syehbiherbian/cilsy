...
<?php $__env->startSection('description', $lessons->meta_desc); ?>
<?php $__env->startSection('content'); ?>

<link href="<?php echo e(asset('node_modules/videojs-playlist-ui/dist/videojs-playlist-ui.vertical.css')); ?>" rel="stylesheet">
<link href="<?php echo e(asset('node_modules/videojs-errors/dist/videojs-errors.css')); ?>" rel="stylesheet">
...
<div id="content-section">
      ...
      <div class="container">
        ...
        <div class="row pt-25 pb-15">
          ...
          <div class="col-xs-12 col-md-2">
            <div class="lesson-video-count">Total <?php echo e(count($main_videos)); ?> Video</div>
          </div>
        </div><!--./ Title -->
            ...
            <div class="col-md-12">
              ...
              <div class="tab-content" style="margin-top:0px;">
                ...
                <div id="tab3" class="tab-pane fade">
                  <?php if ($services) {?>
                      <?php $__currentLoopData = $file; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $files): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                ...
                <div id="tab4" class="tab-pane fade">
                  ...
                  <?php if (empty(Auth::guard('members')->user()->id)) { ?>
                    <div class="text-center mb-25">
                      Silahkan <a href="<?php echo e(url('member/signin')); ?>" class="btn btn-primary"> Masuk</a> untuk memberikan komentar
                    </div>
                  <?php	}else { ?>
                  ...
                  <div class="comments-form mb-25">
                    <!-- <form id="form-comment" class="mb-25">
                      ...
                      <button type="button" class="btn btn-primary" onClick="doComment(<?php echo e($lessons->id); ?>,0)" >Kirim</button>
                    <!-- </form><!--./ Comment Form -->
                  </div>
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="text-center mt-15">
                        <div class="btn-group">
                          ...
                          <button type="button" class="btn btn-primary"><?php echo e($contributors_total_view); ?> View</button>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-9">
  ...
  <script src="<?php echo e(asset('node_modules/video.js/dist/video.js')); ?>"></script>
  <script src="<?php echo e(asset('node_modules/videojs-playlist/dist/videojs-playlist.js')); ?>"></script>
  <script src="<?php echo e(asset('node_modules/videojs-playlist-ui/dist/videojs-playlist-ui.js')); ?>"></script>
...
function lessonsQuiz(videosrc) {
  ...
  $.ajax({
    type: "POST",
    url: "<?php echo e(url('lessons/LessonsQuiz')); ?>",
    data: postData,
    // dataType: "json",
    beforeSend: function() {
