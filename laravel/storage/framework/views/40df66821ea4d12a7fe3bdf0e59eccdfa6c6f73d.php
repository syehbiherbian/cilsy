      ...
      <div class="col-md-6">
        <div class="middle-wrap">
          <div class="inner text-center">
            <?php if (Session::get('memberID')): ?>
              <a href="<?php echo e(url('member/package')); ?>" class="btn btn-default btn-lg">Pilih Paket</a>
            <?php else: ?>
              <a href="<?php echo e(url('member/signup')); ?>" class="btn btn-default btn-lg">Buat Akun</a>
            <?php endif;?>
          </div>
        </div>
      </div>
