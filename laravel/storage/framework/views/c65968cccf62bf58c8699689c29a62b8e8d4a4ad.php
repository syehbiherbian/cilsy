...
<head>
    ...
    <!-- Jquery UI   -->
    <script type="text/javascript" src="<?php echo e(asset('template/web/plugins/jquery-ui-1.12.1.custom/jquery-ui.js')); ?>"></script>
      ...
      <div class="container">
          ...
          <div id="box">
            <?php if(Auth::guard("members")->user()): ?>
              <div id="items" style="top:38%">
                  ...
                  <a href="<?php echo e(url('member/package')); ?>"><div class="item">Perpanjang</div></a>
                  <a href="<?php echo e(url('member/change')); ?>" ><div class="item">Ganti Password</div></a>
                  <a href="<?php echo e(url('member/signout')); ?>"><div class="item">Logout</div></a>
              </div>
              <?php else: ?>
              <div id="items">
                  <a href="<?php echo e(url('lessons/browse/all')); ?>" class="hidden-lg hidden-md" style="color: #fff;"><div class="item browse" style="background-color:#2BA8E2;">Browse Tutorial</div></a>
                  <a href="<?php echo e(url('/carapesan')); ?>"><div class="item">Cara Pesan</div></a>
                  <a href="<?php echo e(url('/member/package')); ?>"><div class="item">Harga</div></a>
                  <a href="<?php echo e(url('member/signin')); ?>"><div class="item">Masuk</div></a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          ...
          <div class="header-menu">
                <ul>
                    ...
                    <li class="has-dropdown">
                        <img src="<?php echo e(asset('template/kontributor/img/icon/Notifikasi.png')); ?>" alt="">
                     ...
                     <li>
                        <span class="hello-user">Halo, <?php echo e(Auth::guard('members')->user()->username); ?></span>
                    </li>
                    <li class="has-dropdown">
                        <img src="<?php echo e(asset('template/kontributor/img/icon/Akun.png')); ?>" alt="">
                        <div class="dropdown-container">
                            <ul>
                                <li>
                                    <a href="<?php echo e(url('member/profile')); ?>">
                                        Profile
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo e(url('member/point')); ?>">
                                        Point
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('member/subscriptions')); ?>">
                                        Riwayat dan Status Langganan
                                    </a>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('member/signout')); ?>">
                                        Logout
                                    </a>
                                </li>
                            </ul>
          ...
          <?php else: ?>
              ...
              <li><a href="<?php echo e(url('lessons/browse/all')); ?>" class="hidden-lg hidden-md">Browse Tutorial</a></li>
              <li><a href="<?php echo e(url('/carapesan')); ?>">Cara Pesan</a></li>
              <li><a href="<?php echo e(url('/member/package')); ?>">Harga</a></li>
                ...
                <div class="drop-down">
                  ...
                  <div class="drop-down-content">
                    <table cellpadding="15">
                      ...
                      <tr>
                        <td><a href="<?php echo e(url('member/package')); ?>" class="btn btn-danger btn-package">Perpanjang</a></td>
                        <td><a href="<?php echo e(url('member/change')); ?>" class="btn btn-success">Ganti Password</a></td>
...
// Set the date we're counting down to
    ...
    <!-- rating -->
    <!-- Custom Js -->
    <script type="text/javascript" src="<?php echo e(asset('template/web/js/custom.js')); ?>"></script>
