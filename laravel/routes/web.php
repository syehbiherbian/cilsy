...
Route::get('member/reset', 'Web\Members\AuthController@forgotpassword');
Route::post('member/reset', 'Web\Members\AuthController@doforgotpassword');
Route::get('member/reset/update/{token}', 'Web\Members\AuthController@updatereset');
Route::post('member/reset/update', 'Web\Members\AuthController@doupdatereset');
