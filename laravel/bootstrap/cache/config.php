<?php return array (
  ...
  array (
    ...
    'encrypt' => false,
    'files' => '/opt/lampp/htdocs/cilsy/laravel/storage/framework/sessions',
    'connection' => NULL,
    'table' => 'sessions',
    'store' => NULL,
    'lottery' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'local',
        'root' => '/opt/lampp/htdocs/cilsy/laravel/storage/app',
      ),
      'public' => 
      array (
        'driver' => 'local',
        'root' => '/opt/lampp/htdocs/cilsy/laravel/storage/app/public',
        'visibility' => 'public',
      ),
      'local_public' => 
      array (
        'driver' => 'local',
        'root' => '/opt/lampp/htdocs/cilsy/laravel/public',
      ),
      's3' => 
      array (
        'driver' => 's3',
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'file',
        'path' => '/opt/lampp/htdocs/cilsy/laravel/storage/framework/cache',
      ),
      'memcached' => 
      array (
        'driver' => 'memcached',
