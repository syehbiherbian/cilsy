									                      ...
									                      <div class="panel-footer ">
									                        <div class="row reply">
                                                              ...
                                                              <form id="form-comment" class="mb-25" enctype="multipart/form-data" method="POST">
                                                                ...
                                                                <input class="inputfile inputfile-2" type="file" name="image" id="file-2" data-multiple-caption="{count} files selected" multiple="multiple"/>
                                                                <label for="file-2"><i class="fa fa-upload"></i><span>Upload Image</span></label>
